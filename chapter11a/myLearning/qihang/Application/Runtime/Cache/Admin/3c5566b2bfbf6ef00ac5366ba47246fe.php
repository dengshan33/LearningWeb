...
<head>
    ...
    <link rel="stylesheet" href="/gongwei/qihang/Public/Admin/css/login.css" />
    <title>教师登录</title>
</head>
<body>
<div id="container">
            ...
            <div class="login1">
                ...
                <div class="login-input">
                    ...
                    <p class="yzm ue-clear">
                        ...
                        -->
                        <cite><img style="margin-left: 3px;" src="/gongwei/qihang/Admin/Public/captcha" onclick="this.src='/gongwei/qihang/Admin/Public/captcha/t/'+Math.random()" /></cite>
                    </p>
                </div>
