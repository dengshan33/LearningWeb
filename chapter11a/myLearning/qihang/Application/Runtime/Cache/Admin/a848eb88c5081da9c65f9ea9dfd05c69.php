...
<section id="3">
    ...
    <div style="margin-left: 45%; margin-top: 10px;">
        <a href="<?php echo U('Notice/deliver');?>" style="font-size: 20px; text-decoration: none;">①课程消息通知(点击发布通知)</a>
    </div>
    <div class="container">
        <div class="raw">
            <div class="col-md-12">
                <div class="col-md-12">
                    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><p>
                        ...
                        <?php if($vol["hasfile"] == 1): ?><font class="file">文件(点击下载)：
                                <?php if(!empty($vol["filename"])): ?><a href='/gongwei/qihang/Admin/View/download/id/<?php echo ($vol["id"]); ?>'>
...
<section id="5">
    ...
    <form action="/gongwei/qihang/Admin/View/service" method="post">
        <div class="container">
            <div class="raw">
                <div class="col-md-12">
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $('.del').on('click',function(){
            ...
            //带着参数跳转到del方法
            window.location.href = '/gongwei/qihang/Admin/View/del/id/' + id;
        });
    });
    ...
    $(function(){
        ...
        $('.show').on('click',function(){
            ...
            layer.open({
                ...
                shade: 0,   //背景透明
                area: ['560px', '90%'],
                content: '/gongwei/qihang/Admin/View/showContent/id/' + id //iframe的url
            });
        });
    });
