        ...
        <div class="raw">
            <div class="col-md-12">
                <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><p>
                            <font class="name" style="color: #46b8da;">学生姓名：<?php echo ($vol["username"]); ?></font>
                            <font class="name" style="color: #46b8da;margin-left: 5%;">所报课程名：<?php echo ($vol["bookname"]); ?></font>
                            <font class="name" style="color: #46b8da;margin-left: 5%;">编号：<?php echo ($vol["book_id"]); ?></font>
                            <font class="addtime"  style="color: black; margin-left: 5%;">报名日期：<?php echo ($vol["addtime"]); ?></font>
                            <font class="content"  style="color:green;margin-left:5%;">课程学时：<?php echo ($vol["addtime"]); ?></font>
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $('.btn').on('click',function(){
            ...
            //带着参数跳转到del方法
            alert(card_id);
            //window.location.href = '/gongwei/qihang/Admin/Borrow/add/card_id' + card_id;
        });
    });
