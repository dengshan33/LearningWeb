...
<section id="2">
    ...
    <div class="container">
        <div class="raw">
            <div class="col-md-3 col-xs-3">
                <img src="/gongwei/qihang/Public/Home/images/index/3.png" height="auto;" class="image"/>
    ...
    <div class="container">
        <div class="raw">
            <div class="col-md-3 col-xs-3">
                <img src="/gongwei/qihang/Public/Home/images/index/1.png" height="auto;" class="image"/>
                <p style="font-size: 15px; color: #46b8da; line-height: 25px;">
                    &nbsp;&nbsp;&nbsp;Rember what should be rembered, and forget what should be forgotten .<br/>
                    &nbsp;&nbsp;&nbsp;Alter what is changeable, and accept what is mutable.
                </p>
    ...
    <div class="container">
        <div class="raw">
            <div class="col-md-3 col-xs-3">
                <img src="/gongwei/qihang/Public/Home/images/index/6.jpg" height="auto;" class="image"/>
                <p style="font-size: 15px; color: #46b8da; line-height: 25px;">
    ...
    <div class="container">
        <div class="raw">
            <div class="col-md-3 col-xs-3">
                <img src="/gongwei/qihang/Public/Home/images/index/4.jpg" height="auto;" class="image"/>
                <p style="font-size: 15px; color: #46b8da; line-height: 25px;">
                    &nbsp;&nbsp;&nbsp;Rember what should be rembered, and forget what should be forgotten .<br/>
                    &nbsp;&nbsp;&nbsp;Alter what is changeable, and accept what is mutable.
                </p>
    ...
    <div class="container">
        <div class="raw">
            <div class="col-md-3 col-xs-3">
                <img src="/gongwei/qihang/Public/Home/images/index/5.jpg" height="auto;" class="image"/>
                <p style="font-size: 15px; color: #46b8da; line-height: 25px;">
                    &nbsp;&nbsp;&nbsp;Rember what should be rembered, and forget what should be forgotten .<br/>
                    &nbsp;&nbsp;&nbsp;Alter what is changeable, and accept what is mutable.
                </p>
