                        ...
                        <div class="col-md-8">
                            <div class="collapse navbar-collapse" id="example-navbar-collapse">
                                <ul class="nav navbar-nav navbar-right" style="margin-top: 20px;">
                                    ...
                                    <li class="ti"><a href="<?php echo U('Admin/Public/login');?>">老师登录</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container" style="position: absolute; margin-left: 270px; margin-top: 5px;">
        <div class="raw">
            <div class="col-md-4 col-xs-4">
                <img src="/gongwei/qihang/Public/Home/images/school/4.jpg" height="230px;" class="image"/>
            </div>
            <div class="col-md-4 col-xs-4">
                <img src="/gongwei/qihang/Public/Home/images/school/5.jpg" height="230px;" class="image"/>
            </div>
            <div class="col-md-4 col-xs-4">
                <img src="/gongwei/qihang/Public/Home/images/school/6.jpg" height="230px;" class="image"/>
            </div>
        </div>
    </div>
</section>
<section id="3" style="background-color: #46b8da;">
    ...
    <div class="container" style="position: absolute; margin-left: 270px; margin-top: 5px;">
        <div class="raw">
            <div class="col-md-4 col-xs-4">
                <img src="/gongwei/qihang/Public/Home/images/school/7.jpg" height="230px;" class="image"/>
            </div>
            <div class="col-md-4 col-xs-4">
                <img src="/gongwei/qihang/Public/Home/images/school/8.jpg" height="230px;" class="image"/>
            </div>
            <div class="col-md-4 col-xs-4">
                <img src="/gongwei/qihang/Public/Home/images/school/9.jpg" height="230px;" class="image"/>
            </div>
        </div>
    </div>
</section>
<section id="4" style="background-color: white;">
    ...
    <div class="container">
        <div class="raw">
            <div class="col-md-4">
                <img src="/gongwei/qihang/Public/Home/images/school/1.gif" height="400px;" style="margin-top: 45px;"/>
            </div>
