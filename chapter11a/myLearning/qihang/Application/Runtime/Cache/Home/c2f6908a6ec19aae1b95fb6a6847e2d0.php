...
<head lang="en">
    ...
    <link rel="stylesheet" href="/ykt/Card-system/Public/Home/css/info-mgt.css"/>
</head>
<body>
...
<section id="1" style="margin-top: 80px;">
    ...
    <div style="margin-left: 45%;">
        <a href="<?php echo U('Card/ad');?>" style="text-decoration: none;">
            <img src="/ykt/Card-system/Public/Home/images/service/service/2.gif" class="img"/>
...
<script type="text/javascript" src="/ykt/Card-system/Public/Home/js/WdatePicker.js"></script>
