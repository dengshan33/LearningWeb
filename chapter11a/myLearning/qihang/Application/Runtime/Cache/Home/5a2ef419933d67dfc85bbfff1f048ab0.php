...
<section id="1">
    <div style="position: relative;">
        ...
        <p id="p1" style="color:red; display: block; position: absolute; text-align:center; margin-left: 25%; margin-top: 100px; font-size: 20px">
            一&nbsp;&nbsp;&nbsp;&nbsp;卡&nbsp;&nbsp;&nbsp;&nbsp;通&nbsp;&nbsp;&nbsp;&nbsp;服&nbsp;&nbsp;&nbsp;&nbsp;务&nbsp;&nbsp;&nbsp;&nbsp;
            中&nbsp;&nbsp;&nbsp;&nbsp;心&nbsp;&nbsp;&nbsp;&nbsp;欢&nbsp;&nbsp;&nbsp;&nbsp;迎&nbsp;&nbsp;&nbsp;&nbsp;您！</p>
        <img id="img1" class="image" style="height: 400px;" src="/gongwei/qihang/Public/Home/images/intro/1.jpg" alt="1"/>
        <p id="p2" style="color:blue; display: none; position: absolute; text-align:center; margin-left: 25%; margin-top: 100px; font-size: 20px">
        一&nbsp;&nbsp;&nbsp;&nbsp;卡&nbsp;&nbsp;&nbsp;&nbsp;通&nbsp;&nbsp;&nbsp;&nbsp;服&nbsp;&nbsp;&nbsp;&nbsp;务&nbsp;&nbsp;&nbsp;&nbsp;
            中&nbsp;&nbsp;&nbsp;&nbsp;心&nbsp;&nbsp;&nbsp;&nbsp;欢&nbsp;&nbsp;&nbsp;&nbsp;迎&nbsp;&nbsp;&nbsp;&nbsp;您！</p>
        <img id="img2"  style="display: none; width: 100%; height: 400px; margin: 0;padding: 0;" src="/gongwei/qihang/Public/Home/images/intro/2.jpg"alt="2"/>
        <p id="p3" style="color:green; display: none; position: absolute; text-align:center; margin-left: 25%; margin-top: 100px; font-size: 20px">
            一&nbsp;&nbsp;&nbsp;&nbsp;卡&nbsp;&nbsp;&nbsp;&nbsp;通&nbsp;&nbsp;&nbsp;&nbsp;服&nbsp;&nbsp;&nbsp;&nbsp;务&nbsp;&nbsp;&nbsp;&nbsp;
            中&nbsp;&nbsp;&nbsp;&nbsp;心&nbsp;&nbsp;&nbsp;&nbsp;欢&nbsp;&nbsp;&nbsp;&nbsp;迎&nbsp;&nbsp;&nbsp;&nbsp;您！</p>
        <img id="img3" style="display:none; width: 100%; height: 400px;" src="/gongwei/qihang/Public/Home/images/intro/3.jpg" alt="3"/>
    </div>
</section>
...
<section id="2" style="background-color:white;">
    ...
    <div class="container" style="margin-top: 10px;">
        <div class="raw">
            <div class="col-md-4">
                <img src="/gongwei/qihang/Public/Home/images/service/index/1.png" class="img"/>
                <a href="#3" style="font-size: 20px; color: #46b8da; text-decoration: none;">消息通知</a>
            </div>
            <div class="col-md-4">
                <img src="/gongwei/qihang/Public/Home/images/service/index/2.png" class="img"/>
                <a href="#4" style="font-size: 20px; text-decoration: none;">主体服务</a>
            </div>
            <div class="col-md-4">
                <img src="/gongwei/qihang/Public/Home/images/service/index/3.png" class="img"/>
...
<section id="3">
    <hr style="margin: 0 0 0 0; height: 1px; width: auto;background: #46b8da;"/>
        <div style="margin-left: 45%; margin-top: 10px;">
            <a href="#3" style="font-size: 20px; text-decoration: none;">①课程消息通知</a>
        </div>
    <div class="container">
        <div class="raw">
            <div class="col-md-12">
                <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><p>
                    ...
                    <?php if($vol["hasfile"] == 1): ?><font class="file" style="margin-left: 18px;">文件(点击下载)：
                            <?php if(!empty($vol["filename"])): ?><a href='/gongwei/qihang/Home/View/download/id/<?php echo ($vol["id"]); ?>'>
...
<section id="5">
    ...
    <form action="/gongwei/qihang/Home/View/service" method="post">
    <div class="container">
        <div class="raw">
            <div class="col-md-6">
        ...
        <div class="raw">
            ...
            <div class="col-md-5 col-xs-5">
                ...
                <p><a href="<?php echo U('Back/index');?>" style="text-decoration: none;">个人信息</a>
                    <a style="margin-left: 20px;text-decoration: none;" href="<?php echo U('Borrow/index');?>">课程管理</a></p>
            </div>
        </div>
    </div>
</footer>
