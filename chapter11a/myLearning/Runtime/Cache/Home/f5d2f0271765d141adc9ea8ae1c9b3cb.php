							...
							<div class="single-service">
								<div class="thumb" style="background: url(/chapter11a/Public/Uploads/teacherPic/<?php echo ($v["jpic"]); ?>);">
									<div class="overlay overlay-content d-flex justify-content-center align-items-center">
										<a href="#" class="primary-btn hover d-inline-flex align-items-center"><span class="mr-10"><?php echo ($v["jname"]); ?></span><span class="lnr lnr-arrow-right"></span></a>
									</div>
								</div>
								<div class="desc">
									<h3 class="text-uppercase text-white"><?php echo (msubstr($v["tspec"],0,6,'utf-8',true)); ?></h6>
					...
					<?php if(is_array($list2)): foreach($list2 as $key=>$v): ?><div class="col-lg-3 col-sm-6">
							<div class="single-service">
								<div class="thumb" style="background: url(/chapter11a/Public/Uploads/couPic/<?php echo ($v["tpic"]); ?>);">
									<div class="overlay overlay-content d-flex justify-content-center align-items-center">
										<a href="<?php echo U('kaoyan/course','tid='.$v['tno']);?>" class="primary-btn hover d-inline-flex align-items-center"><span class="mr-10"><?php echo ($v["tname"]); ?></span><span class="lnr lnr-arrow-right"></span></a>
									</div>
								</div>
								<div class="desc">
									<h6 class="text-uppercase text-white"><?php echo (msubstr($v["tname"],0,10,'utf-8',true)); ?></h6>
									<p class="text-white"><?php echo (msubstr($v["tprofile"],0,20,'utf-8',true)); ?></p>
								</div>
								<div>
									<a class="button" style="font-size:25px;margin-top:10px;color:#FFF0F5;" href="<?php echo U('Stusercenter/addcollecttj','s='.$v['tno']);?>">收藏</a>
									<a class="button" style="font-size:25px;margin-top:10px;margin-left:30px;color:#FFF0F5;" href="<?php echo U('Stusercenter/addcoursetj','s='.$v['tno']);?>">选课</a>
								</div>
							</div>
						</div><?php endforeach; endif; ?>
					</div>
					...
					<?php if(is_array($list1)): foreach($list1 as $key=>$v): ?><div class="col-lg-3 col-sm-6">
							<div class="single-service">
								<div class="thumb" style="background: url(/chapter11a/Public/Uploads/schPic/<?php echo ($v["kpic"]); ?>);">
									<div class="overlay overlay-content d-flex justify-content-center align-items-center">
										<a href="#" class="primary-btn hover d-inline-flex align-items-center"><span class="mr-10"><?php echo ($v["kname"]); ?></span><span class="lnr lnr-arrow-right"></span></a>
									</div>
								</div>
								<div class="desc">
