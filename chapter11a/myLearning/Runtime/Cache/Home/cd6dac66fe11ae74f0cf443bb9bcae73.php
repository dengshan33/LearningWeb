					...
					<div class="row justify-content-center d-flex">
						<div class="col-lg-10 post-list">
							...
							<?php if(is_array($list1)): foreach($list1 as $key=>$v): ?><div class="single-post d-flex flex-row">
								<div class="thumb">
									<img src="/chapter11a/Public/home/job/img/<?php echo ($v["ipic"]); ?>"  style="width:200px;height:200px; " alt="">
								</div>
								<div class="details">
									<div class="title d-flex flex-row justify-content-between">
										<div class="titles">
											<a href="single.html"><h4><?php echo ($v["iindustry"]); ?></h4></a>
														
										</div>
										<ul class="btns">
											<li><a href="#"><span class="lnr lnr-heart"></span></a></li>
											<li><a href="<?php echo U('job/idetail','iid='.$v['iid']);?>">查看</a></li>
										</ul>
									</div>
									<p>
										基本要求<?php echo ($v["iprofile"]); ?>
									</p>
									<p>
									行业职位<?php echo ($v["ijob"]); ?>
									</p>
