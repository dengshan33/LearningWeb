...
<div class="main">
    ...
    <form class="login-form" method="post"  >
        ...
        <div class="input-content">
            ...
            <div>
                <input type="text" autocomplete="off"
                       placeholder="学号" name="numb" required/>
            </div>
            ...
            <div style="margin-top: 16px">
             ...
             <div style="margin-top: 16px">
            	...
            	<tr><td><img  style="margin-top: 10px" src="/chapter11a/Home/Stulogin/captcha" onclick="this.src='/chapter11a/Home/Stulogin/captcha/'+Math.random()"/></td></tr>
        	</div>
        </div>
        ...
        <div class="foor">
            ...
            <div class="right"><span><a href="/chapter11a/Home/Stulogin/sturegister">注册账户</a></span></div>
        </div>
    </form>
