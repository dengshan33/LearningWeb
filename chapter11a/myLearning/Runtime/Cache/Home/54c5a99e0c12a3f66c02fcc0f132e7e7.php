            ...
            <div style="width:1200px;height:500px">
                ...
                <?php if(is_array($cours)): foreach($cours as $key=>$nn): ?><div class="single_course ">
                        ...
                        <div class="course_head overlay aa">
                            <img class="img-fluid w-100" style="width:300px;height:250px" src="/chapter11a/Public/Uploads/couPic/<?php echo ($nn["cpic"]); ?>" alt="">
                            
                            <div class="info">
							      <p><?php echo (msubstr($nn["cname"],0,8,'utf-8',true)); ?></p>							                     
							      <p style="font-size: 14px;">课程号：<?php echo ($nn["cno"]); ?></p>
							 </div>
                        </div>
                        <div class="course_content" style="width:300px;height:250px">
                            <h4>
                                <a href="<?php echo U('Stusercenter/content','b='.$nn['cno']);?>" title="<?php echo ($nn["cname"]); ?>"><?php echo (msubstr($nn["cname"],0,10,'utf-8',true)); ?></a>
                            </h4>
                            <p><?php echo (msubstr($nn["cprofile"],0,15,'utf-8',true)); ?></p>
                            <div class="course_meta d-flex justify-content-between">
                                ...
                                <div>
                                    <span class="price">
                                    <a href="<?php echo U('Stusercenter/deleteCour','sid='.$nn['sid']);?>">退课</a></span>
                                </div>
                            </div>
                        </div>
