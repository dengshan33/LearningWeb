            ...
            <div class="row" style="width:1000px;margin-left:80px;;">
                <div class="col-lg-8 course_details_left" >
                    <div class="main_image">
                        <img class="img-fluid" style="width:500px;height:350px" src="/chapter11a/Public/Uploads/couPic/<?php echo ($cour["cpic"]); ?>" alt="" />
                    </div>
                    <div class="content_wrapper">
                        <h4 class="title">课程详情</h4>
                        <div class="content">
                           <p><?php echo ($cour["cname"]); ?></p>
                            <br />
                    ...
                    <ul>
                        <li>
                            <a class="justify-content-between d-flex" href="#">
                                <p>授课老师</p>
                                <span class="or"><?php echo ($teacher["tname"]); ?></span>
                            </a>
                        </li>
                        <li>
                            <a class="justify-content-between d-flex" href="#">
                                <p>课程号</p>
                                <span><?php echo ($cour["cno"]); ?></span>
                            </a>
                        </li>
                        <li>
                            <a class="justify-content-between d-flex" href="#">
                        ...
                        <li>
                            <a class="justify-content-between d-flex" href="#">
                                <p>发布时间</p>
                                <span><?php echo ($cour["ctime"]); ?></span>
                            </a>
                        </li>
                    </ul>
                    
                    <h4 class="title">老师信息</h4>
                    <div class="content">
                        <div class="review-top row pt-40">
                            <div class="col-lg-12">
                               
                                <div class="d-flex flex-row reviews justify-content-between">
                                    <p>所属学院:&nbsp;&nbsp;&nbsp;<?php echo ($teacher["tcolle"]); ?></p>
                                </div>
                                <div class="d-flex flex-row reviews justify-content-between">
                                    <p>邮&nbsp;&nbsp;&nbsp;&nbsp;箱:&nbsp;&nbsp;&nbsp;<?php echo ($teacher["temail"]); ?></p>
                                </div>
