				...
				<div class="container">
					...
					<div class="row">
						<div class="col-lg-2 col-md-4 col-sm-6">
							<div class="single-fcat">
								<a href="category.html">
									<img src="/chapter11a/Public/home/job/img/o1.png"  alt="">
								</a>
								<p>会计</p>
							</div>
						</div>
						<div class="col-lg-2 col-md-4 col-sm-6">
							<div class="single-fcat">
								<a href="category.html">
									<img src="/chapter11a/Public/home/job/img/o2.png" alt="">
								</a>
								<p>开发</p>
							</div>
						</div>
						<div class="col-lg-2 col-md-4 col-sm-6">
							<div class="single-fcat">
								<a href="category.html">
									<img src="/chapter11a/Public/home/job/img/o3.png" alt="">
								</a>
								<p>技术</p>
							</div>
						</div>
						<div class="col-lg-2 col-md-4 col-sm-6">
							<div class="single-fcat">
								<a href="category.html">
									<img src="/chapter11a/Public/home/job/img/o4.png" alt="">
								</a>
								<p>媒体与新闻</p>
							</div>
						</div>
						<div class="col-lg-2 col-md-4 col-sm-6">
							<div class="single-fcat">
								<a href="category.html">
									<img src="/chapter11a/Public/home/job/img/o5.png" alt="">
								</a>
								<p>教师</p>
							</div>
						</div>
						<div class="col-lg-2 col-md-4 col-sm-6">
							<div class="single-fcat">
								<a href="category.html">
									<img src="/chapter11a/Public/home/job/img/o6.png" alt="">
								</a>
								<p>软件测试</p>
							</div>			
						</div>																											
				...
				<div class="container">
					<div class="row justify-content-center d-flex">
						<div class="col-lg-10 post-list">
							<ul class="cat-list">
								<li><a href="<?php echo u('job/index');?>">公司信息</a></li>
								<li><a href="<?php echo u('job/industry');?>">行业信息</a></li>
								<li><a href="<?php echo u('job/employe');?>">招聘信息</a></li>
							</ul>
							<?php if(is_array($list1)): foreach($list1 as $key=>$v): ?><div class="single-post d-flex flex-row">
								<div class="thumb">
									<img src="/chapter11a/Public/home/job/img/<?php echo ($v["mpic"]); ?>"  style="width:100px;height:100px" alt="">
									
								</div>
								<div class="details">
									<div class="title d-flex flex-row justify-content-between">
										<div class="titles">
											<a href="single.html"><h4><?php echo ($v["mname"]); ?></h4></a>
											<h6><?php echo ($v["firm"]); ?></h6>					
										</div>
										<ul class="btns">
										
											<li><a href="<?php echo U('job/mdetail','mid='.$v['mid']);?>">查看</a></li>
										</ul>
									</div>
									<p>
										基本要求<?php echo ($v["mrequire"]); ?>
									</p>
									<h5>工作时间：<?php echo ($v["mtime"]); ?></h5>
									<p class="address"><span class="lnr lnr-map"></span>工作地点：<?php echo ($v["mlocation"]); ?></p>
									<p class="address"><span class="lnr lnr-database"></span> <?php echo ($v["msalary"]); ?></p>
								</div>
							</div><?php endforeach; endif; ?>
							<div align="right" font-wight=bold>
							<?php echo ($page1); ?>
							</div>
						</div>
