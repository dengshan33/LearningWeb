...
<body>
    ...
    <!--====== HEADER  PART ENDS ======-->
<div class="banner-a">
<div class="banner-area d-flex align-items-center bg_cover" style="background-image: url(/chapter11a/Public/home/assets/images/lunbo1.jpg);">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        <div class="banner-content text-center">
                            <h1 data-animation="fadeInUp" data-delay="0.5s" class="title">启航</h1>
                            <a data-animation="fadeInUp" data-delay="1.2s" class="main-btn" href="#">SHOP Now</a>
                        </div>
                    </div>
                </div> <!-- row -->
            </div> <!-- container -->
            <div class="banner-shape">
                <img src="/chapter11a/Public/home/assets/images/banner-shape.png" alt="shape">
            </div>
        </div> <!-- banner area -->
