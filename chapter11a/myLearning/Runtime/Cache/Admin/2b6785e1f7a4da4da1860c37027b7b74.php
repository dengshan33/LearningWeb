...
<div style="margin-top: 20px">
    ...
    <br />
    <p style="color:#8AAEB8;">被删除招聘id为：<?php echo ($nid); ?></p>
    <br />
    ...
    <form action="" method="post">
        ...
        <a class="btn btn-default" href="/chapter11a/Admin/EmployManage/detailmp/nid/<?php echo ($nid); ?>">取消</a>
