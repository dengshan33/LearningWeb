...
<p><span style="border-right:4px solid gray;margin-right:5px;padding-left:10px;"></span>
    ...
    &gt;<font color="#8AAEB8">删除行业信息</font>
</p>
<hr style="margin-top: 10px;margin-bottom: 0px;border-top: 2px solid #8AAEB8;"/>

<div style="margin-top: 20px">
    <p style="color:#8AAEB8;">您好，<?php echo ($adminName); ?>管理员，您将执执行删除行业信息操作</p>
    <br />
    <p style="color:#8AAEB8;">被删除行业id为：<?php echo ($nid); ?></p>
    <br />
    ...
    <form action="" method="post">
        ...
        <a class="btn btn-default" href="/chapter11a/Admin/EmployManage/detailind/nid/<?php echo ($nid); ?>">取消</a>
