...
<p><span style="border-right:4px solid gray;margin-right:5px;padding-left:10px;"></span>
    <font color="#8AAEB8" size="4">用户管理</font> &gt;<font color="#8AAEB8">查询用户</font> </p>
<hr style="margin-top: 10px;margin-bottom: 0px;border-top: 2px solid #8AAEB8;"/>

<div style="margin-top: 20px">
    <form action="" method="post">
    	<div class="form-group">
            <label for="type" style="color: #8AAEB8">输入要查找的用户类型(students/teachers)</label>
        ...
        <div class="form-group">
            <label for="id" style="color: #8AAEB8">输入要查询用户的学号（工号）</label>
            <input style="width: 50%;" type="text" class="form-control" name="search" value="<?php echo ($user); ?>" id="id" placeholder="Please enter the ID or username of the user you want to query">
        </div>

        <button type="submit" class="btn btn-default">搜索</button>
    </form>
    <div >
        <table class="table" style="color: #8AAEB8">
            <thead>
            <tr>
            ...
            <tr >
                <td><?php echo ($data1["sid"]); echo ($data2["tid"]); ?></td>
                <td><?php echo ($data1["sno"]); echo ($data2["tno"]); ?></td>
                <td><?php echo ($data1["ssex"]); echo ($data2["tsex"]); ?></td>
                <td><?php echo ($data1["sname"]); echo ($data2["tname"]); ?></td>
                <td><?php echo ($data1["scolle"]); echo ($data2["tcolle"]); ?></td>
                <td><?php echo ($data1["stime"]); echo ($data2["ttime"]); ?></td>
                <td><?php echo ($data1["freeze"]); echo ($data2["freeze"]); ?></td>
