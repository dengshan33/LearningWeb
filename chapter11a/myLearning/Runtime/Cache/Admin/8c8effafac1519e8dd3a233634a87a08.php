            ...
            <div  style="height: 668px;width: 200px;background-color: teal;">
                <div class="userManage">
                    ...
                    <button class="userAction userView" onclick="location='/chapter11a/Admin/UserManagement/userstudentsView'" style="width: 200px;">查看学生</button><br />
                     <button class="userAction userView" onclick="location='/chapter11a/Admin/UserManagement/userteachersView'" style="width: 200px;">查看老师</button><br />
                    <button class="userAction banUser"  onclick="location='/chapter11a/Admin/UserManagement/selectBanUser'" style="width: 200px;">搜索用户</button><br />
...
<p><span style="border-right:4px solid gray;margin-right:5px;padding-left:10px;"></span>
    <font color="#8AAEB8" size="4">用户管理</font> &gt;<font color="#8AAEB8">封禁用户</font> </p>
<hr style="margin-top: 10px;margin-bottom: 0px;border-top: 2px solid #8AAEB8;"/>

<div style="margin-top: 20px">
    <form action="/chapter11a/Admin/UserManagement/selectBanUser" method="post">
        <div class="form-group">
            <label for="id" style="color: #8AAEB8">输入要封禁用户的用户名</label>
            <input style="width: 50%;" type="text" class="form-control" name="search" value="<?php echo ($user); ?>" id="id" placeholder="Enter the username of the user to block">
        </div>
    ...
    <div >
        <table class="table" style="color: #8AAEB8">
            ...
            <tr >
                ...
                <td><?php echo ($data["freeze"]); ?></td>
                <td><?php echo ($data["reg_time"]); ?></td>
                <td><a href="/chapter11a/Admin/UserManagement/banUser/mid/<?php echo ($data["mid"]); ?>" ><?php echo ($a); ?></a></td>
            </tr>
        </table>
    </div>
</div>
