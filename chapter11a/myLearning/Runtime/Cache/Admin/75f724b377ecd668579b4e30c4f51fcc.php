...
<p><span style="border-right:4px solid gray;margin-right:5px;padding-left:10px;"></span>
    <font color="#8AAEB8" size="4">就业信息</font> &gt;<font color="#8AAEB8">行业信息</font>
    &gt;<font color="#8AAEB8">添加行业信息</font>
</p>
<hr style="margin-top: 10px;margin-bottom: 0px;border-top: 2px solid #8AAEB8;"/>
        ...
        <div class="col-sm-6 col-xs-6">
            <form action="" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    <label for="newsTitle">请输入行业名</label>
                    <input type="text" class="form-control" name="iindustry" id="newsTitle" />
                </div>
                <div class="form-group">
                    <label for="newContent">请输入行业简介</label>
                    <textarea type="text" rows="4" class="form-control" name="iprofile" id="newsContent" ></textarea>
                </div>
                <div class="form-group">
                    <label for="newContent">请输入行业现状</label>
                    <textarea type="text" rows="4" class="form-control" name="inow" id="newsContent" ></textarea>
                </div>
                <div class="form-group">
                    <label for="newContent">请输入行业发展</label>
                    <textarea type="text" rows="4" class="form-control" name="ifazhan" id="newsContent" ></textarea>
                </div>
                <div class="form-group">
                    <label for="newContent">请输入行业职位</label>
                    <textarea type="text" rows="4" class="form-control" name="ijob" id="newsContent" ></textarea>
                </div>
               <div class="form-group">
                    <label for="newContent">请选择图片</label>
                   <input name="ipic" type="file" value="" size="58"/>
                </div>
                <a class="btn btn-default" href="/chapter11a/Admin/EmployManage/industryinfo" >取消</a>
