...
<p><span style="border-right:4px solid gray;margin-right:5px;padding-left:10px;"></span>
    <font color="#8AAEB8" size="4">公共信息</font> &gt;<font color="#8AAEB8">推荐书籍</font>
    &gt;<font color="#8AAEB8">添加推荐书籍</font>
</p>
<hr style="margin-top: 10px;margin-bottom: 0px;border-top: 2px solid #8AAEB8;"/>
        ...
        <div class="col-sm-6 col-xs-6">
            <form action="" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    <label for="newsTitle">请输入书名</label>
                    <input type="text" class="form-control" name="sname" id="newsTitle" />
                </div>
                <div class="form-group">
                    <label for="newContent">请输如书籍价格</label>
                     <input type="text" class="form-control" name="sprice" id="newsTitle" />
                </div>
               
               <div class="form-group">
                    <label for="newContent">请选择书籍图片</label>
                   <input name="spic" type="file" value="" size="58"/>
                </div>
                <a class="btn btn-default" href="/chapter11a/Admin/Pub/book" >取消</a>
