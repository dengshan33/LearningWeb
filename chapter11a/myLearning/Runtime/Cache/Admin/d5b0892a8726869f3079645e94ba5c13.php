...
<div style="width:1200px;margin-left: 20px; background: rgba(255, 255, 255, 0.8);">
    <div class="1">
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2" >
            <div  style="height: 668px;width: 200px;background-color: #FF9900;margin-left:5px;">
...
<p><span style="border-right:4px solid gray;margin-right:5px;padding-left:10px;"></span>
    <font color="#8AAEB8" size="4">用户管理</font> &gt;<font color="#8AAEB8">查看学生信息</font> </p>
<hr style="margin-top: 10px;margin-bottom: 0px;border-top: 2px solid #8AAEB8;"/>
...
<div style="margin-top: 20px">
    <table class="table table-hover" style="color: #8AAEB8">
        ...
        <?php if(is_array($list)): foreach($list as $key=>$v): ?><tr style="color: #8AAEB8">
                ...
                <td><?php echo ($v["scolle"]); ?></td>
                <td><?php echo ($v["syear"]); ?></td>
                <td><?php echo ($v["smajor"]); ?></td>
                <td><?php echo ($v["sclass"]); ?></td>
                <td><?php if($v["freeze"] == 0 ): ?>未冻结
					<?php else: ?>已冻结<?php endif; ?></td></td>
                <td><?php echo ($v["stime"]); ?></td>
                <td><?php if($v["freeze"] == 1 ): ?><a href="<?php echo U('nofreezeS','fid='.$v['sid']);?>">解冻</a>
					<?php else: ?><a href="<?php echo U('isfreezeS','fid='.$v['sid']);?>">冻结</a><?php endif; ?>
				</td>
