...
<div style="width:1200px;margin-left: 20px; background: rgba(255, 255, 255, 0.5);">
    <div class="1">
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2" style="background-color:#FF9900">
            <div  style="height: 668px;width: 200px;background-color: #FF9900;margin-left:10px;">
    ...
    <table class="table table-hover" style="color:#8AAEB8">
        ...
        <tbody style="color: #8AAEB8">
           <?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
                 ...
                 <td><?php echo ($v["mfirm"]); ?></td>
                 
                   <td><a href="/chapter11a/Admin/EmployManage/detailmp/nid/<?php echo ($v["mid"]); ?>" >详情...</a></td>
